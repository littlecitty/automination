...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def open_second_window(self):
        if self.second_window is None:
            self.second_window = uic.loadUi("test2.ui")  # Load test2.ui
            self.second_window.show()  # Show the second UI
        else:
            self.second_window.show()  # If already opened, just show it again
